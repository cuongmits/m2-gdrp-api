...
class CustomerBasedQocSetProviderSpec extends ObjectBehavior
{
    function let(
        ...
        $connection->getTableName(Argument::any())->willReturn('table name');
    ...
    {
        $this->shouldHaveType(CustomerBasedQocSetProvider::class);
    }
